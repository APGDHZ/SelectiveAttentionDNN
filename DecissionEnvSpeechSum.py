...
# All rights reserved.
# ==============================================================================
'''This code represents decission architecture. The left and the right stimulus envelope were appended to the lagged EEG data matrix'''
...
def createModel():
    ...
    model.add(Dense(n_hidden**(5), input_shape=(Window10s, (numChans+1)*2), activation='relu', use_bias=True))    
